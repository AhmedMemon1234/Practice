    ...
    return(
      ...
      <div className='flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full'>
        ...
        <div className='flex gap-4 ml-auto'>
          <div
            className='flex max-w-xs w-full bg-gray-100 px-4 py-2 rounded outline outline-transparent border focus-within:border-blue-600 focus-within:bg-transparent transition-all'>
